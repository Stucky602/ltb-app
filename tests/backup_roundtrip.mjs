...
// the only thing protecting Kevin's data.
{
  ...
  const EXCLUDED = {
    ...
    WEEK_SECTIONS_KEY: 'which menu sections are on offer this week — published with the week, not device state. Deliberately NOT restored: a month-old backup would silently re-limit a live menu, and absent already reads as everything on',
