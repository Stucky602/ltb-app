...
export const styles = {
  ...
  // ── Weekly recap modal ─────────────────────────────────────────────────────
  summaryModalCard: { width: '100%', maxWidth: '440px', background: CARD, border: `1px solid ${TEAL_MID}`, borderRadius: '14px', padding: '18px', boxSizing: 'border-box', maxHeight: '88vh', overflowY: 'auto' },
  summaryModalHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '14px' },
  summaryModalTitle: { fontSize: '17px', fontWeight: 700, color: '#fff' },
  summaryModalClose: { background: 'transparent', border: 'none', color: '#9aa5a0', cursor: 'pointer', padding: '4px', display: 'flex' },
  summaryLifetimeRow: { display: 'flex', gap: '8px', marginBottom: '14px' },
  summaryLifetimeStat: { flex: 1, background: 'linear-gradient(135deg, #14302e, #1a1a1a)', border: `1px solid ${TEAL_MID}`, borderRadius: '10px', padding: '12px', textAlign: 'center' },
  summaryLifetimeNum: { fontSize: '19px', fontWeight: 800, color: GOLD },
  summaryLifetimeLabel: { fontSize: '10px', color: '#9aa5a0', textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: '3px' },
  summaryWeekList: { display: 'flex', flexDirection: 'column', gap: '10px' },
  summaryWeekCard: { background: '#1a2320', border: '1px solid #2d3a36', borderRadius: '10px', padding: '12px 14px' },
  summaryWeekHead: { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '10px' },
  summaryWeekDate: { fontSize: '13px', fontWeight: 700, color: TEAL_LIGHT },
  summaryWeekCount: { fontSize: '11px', color: '#9aa5a0' },
  summaryWeekStats: { display: 'flex', gap: '8px' },
  summaryWeekStat: { flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' },
  summaryWeekStatLabel: { fontSize: '9px', color: '#7a8480', textTransform: 'uppercase', letterSpacing: '0.04em' },
  summaryWeekStatVal: { fontSize: '14px', fontWeight: 700, color: CREAM },
  summaryDishBreakdown: { marginTop: '12px', paddingTop: '10px', borderTop: '1px dashed #2d3a36' },
  summaryDishTitle: { fontSize: '10px', fontWeight: 700, color: GOLD, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '6px' },
  summaryDishRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', fontSize: '12px', color: '#d8d2c4', padding: '2px 0' },
  summaryDishName: { flex: 1, paddingRight: '8px' },
  summaryDishQty: { fontWeight: 700, color: GOLD },
  summaryFootnote: { fontSize: '10px', color: '#7a8480', fontStyle: 'italic', marginTop: '14px', lineHeight: 1.4 },
};
