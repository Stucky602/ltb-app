...
export const INGREDIENT_SEED = [
  ...
  { id: 'cantaloupe', name: 'Cantaloupe', unit: 'each', baseline: 3.0, category: 'produce' },
  ...
  { id: 'guittard_low', name: 'Guittard chocolate (low %)', unit: '145g', baseline: 3.5, category: 'pantry' },
  { id: 'guittard_high', name: 'Guittard chocolate (high %)', unit: '145g', baseline: 3.5, category: 'pantry' },
